...
- Inline formatting:
    **text** → <b>
    ...
    ((text)) → remove 'c' and 'C' characters
"""
...
def parse_bold_emphasis(text):
    ...
    Args:
        text (str): Input text containing Markdown formatting.

    Returns:
        str: Text with <b> and <em> tags replacing Markdown syntax.
    """
...
def parse_special_syntax(text):
    ...
    - [[text]] → replace with MD5 hash of text.
    - ((text)) → remove all 'c' and 'C' characters.
...
def process_line_formatting(text):
    ...
    Returns:
        str: Text with all inline transformations applied.
    """
